...
object AccessGUIConfig : IConfigFile {
    ...
    var typeMenuBackgroundFill = SerializableItem(Material.BLACK_STAINED_GLASS_PANE, "&f", listOf(), 1)
    var typeMenuFactionsItem = InterfaceItem(
            false,
            Coordinate(1, 3),
            SerializableItem(Material.DIAMOND_SWORD, "&e&l* &f&lFACTIONS &e&l*", listOf(
                    "&d",
    ...
    var typeMenuPlayersItem = InterfaceItem(
            false,
            Coordinate(1, 5),
            SerializableItem(Material.PLAYER_HEAD, "&e&l* &f&lPLAYERS &e&l*", listOf(
                    "&d",
                    "&7Click this to enter a menu where you will be",
                    "&7able to modify the &6&l&nACCESS&7 of specific claims",
    ...
    var chunkMenuBackgroundFill = SerializableItem(Material.BLACK_STAINED_GLASS_PANE, "&f", listOf(), 1)
    ...
    var chunkMenuNextButton = InterfaceItem(
            ...
            SerializableItem(Material.STONE_BUTTON, "&6&lNEXT &8>>", listOf(
    ...
    var chunkMenuPreviousButton = InterfaceItem(
            ...
            SerializableItem(Material.STONE_BUTTON, "&8<< &6&lPREVIOUS", listOf(
                "&7Click this to navigate to the",
    ...
    var objectsMenuBackgroundFill = SerializableItem(Material.BLACK_STAINED_GLASS_PANE, "&f", listOf(), 1)
    var objectsMenuItemsPerPage = 18
    var objectsMenuStartCoordinate = Coordinate(1, 0)
    var objectsMenuName = "&e&l* &f&l{NAME} &e&l*"
    var objectsMenuMaterialFactions = Material.GRAY_TERRACOTTA
    var objectsMenuMaterialPlayers = Material.PLAYER_HEAD
    ...
    var modificationMenuBackgroundFill = SerializableItem(Material.BLACK_STAINED_GLASS_PANE, "&f", listOf(), 1)
